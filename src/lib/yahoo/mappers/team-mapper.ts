...
import { mapPlayers } from "./game-mapper";
...
export function mapMatchups(ms: any) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    if (matchup.matchup_grades) {
      matchup.matchup_grades = matchup.matchup_grades.map((grade: any) => {
        return {
...
export function mapTeamPoints(team: any, points: any) {
...
export function parseCollection(ts: any, subresources: any) {
...
export function parseLeagueCollection(ls: any, subresources: any) {
...
export function parseTeamCollection(ts: any, subresources: any) {
  const count = ts.count;
  const teams = [];
...
export function parseGameCollection(gs: any, subresources: any) {
