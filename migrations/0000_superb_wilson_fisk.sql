CREATE TABLE "stats" (
	...
	CONSTRAINT "stats_league_key_team_id_week_pk" PRIMARY KEY("league_key","team_id","week")
);
...
CREATE TABLE "user_to_league" (
	...
	"league_key" text NOT NULL,
	"team_id" integer NOT NULL,
	CONSTRAINT "user_to_league_user_id_league_key_pk" PRIMARY KEY("user_id","league_key")
);
--> statement-breakpoint
CREATE TABLE "users" (
