...
export function mapPlayer(p: any) {
...
export function mapPoints(points: any) {
...
export function mapOwnership(ownership: any) {
  const o: any = {
...
export function mapDraftAnalysis(da: any) {
  return mergeObjects(da);
}

export function parseCollection(ps: any, subresources: any) {
